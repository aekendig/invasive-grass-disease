...
write_csv(tidy(mvBioGhMod, conf.method = "HPDinterval", rhat = T, ess = T), 
          "output/mv_biomass_fungicide_effects_greenhouse_2019.csv")
...
write_csv(tidy(evBioGhMod, conf.method = "HPDinterval", rhat = T, ess = T), 
          "output/ev_biomass_fungicide_effects_greenhouse_2019.csv")
...
write_csv(tidy(mvSeedGhMod, conf.method = "HPDinterval", rhat = T, ess = T), 
          "output/mv_seed_fungicide_effects_greenhouse_2019.csv")
