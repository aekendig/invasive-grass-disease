...
# seed distribution
ggplot(dat, aes(x = seeds)) +
  geom_density()

ggplot(dat, aes(x = seeds)) +
  geom_density() +
  facet_wrap(~ age, scales = "free")
# each age by itself looks like combined

# relationship
ggplot(dat, aes(x = spikelet_weight.g, y = seeds, color = age)) +
  geom_point() +
  geom_smooth(method = "lm")
# slope for ages are almost equal, intercept should be zero
