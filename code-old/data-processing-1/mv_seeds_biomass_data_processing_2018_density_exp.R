...
# mv_processed_seeds_2018_density_exp.csv
...
bio <- read_csv("data/mv_biomass_oct_2018_density_exp.csv")
...
write_csv(bio2, "intermediate-data/mv_processed_biomass_oct_2018_density_exp.csv")